        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Competitions_AspNetUsers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogPosts_Competitions_CompetitionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DesignerUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DesignerUsers_AspNetUsers_DesignerId",
                        column: x => x.DesignerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DesignerUsers_Competitions_CompetitionId",
                        column: x => x.CompetitionId,
                        principalTable: "Competitions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CompetitionId = table.Column<int>(type: "int", nullable: false),
                    DesignerUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DesignerUserId1 = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogPosts_CompetitionId",
                table: "BlogPosts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DesignerUsers_CompetitionId",
                table: "DesignerUsers",
                column: "CompetitionId");

            migrationBuilder.CreateIndex(
                name: "IX_DesignerUsers_DesignerId",
                table: "DesignerUsers",
                column: "DesignerId");
